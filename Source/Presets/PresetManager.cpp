...
namespace
{
    ...
    const Resource presetResources[] = {
        ...
        { BinaryData::video_feedback_frag,     BinaryData::video_feedback_fragSize },
        { BinaryData::tri_color_waves_frag,    BinaryData::tri_color_waves_fragSize },
        { BinaryData::wave_sphere_frag,        BinaryData::wave_sphere_fragSize },
        { BinaryData::image_fragments_frag,    BinaryData::image_fragments_fragSize },
        { BinaryData::image_feedback_zoom_frag, BinaryData::image_feedback_zoom_fragSize },
        { BinaryData::ocean_floor_frag,        BinaryData::ocean_floor_fragSize },
